...
import com.metrocem.mis.DeliveryInfo.OrderDeliveredActivity;
...
public class DeliveryInfoFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        LinearLayout pendingBtn = view.findViewById(R.id.partialDeliveredBtn);
        pendingBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), OrderDeliveredActivity.class);
                intent.putExtra("ORDER_STATUS", "Partial_Delivered");
                getActivity().startActivity(intent);
                //getActivity().overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
